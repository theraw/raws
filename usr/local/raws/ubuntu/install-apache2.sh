...
echo -n "Installing Php5 Modules..." | lolcat -a -s 100; apt-get install -y libapache2-mod-php5 php5-mysql php5-curl php5-gd libssh2-php php5-intl php-pear php5-imagick php5-imap php5-mcrypt php5-ming php5-ps php5-pspell php5-recode php5-snmp php5-sqlite php5-tidy php5-xmlrpc php5-xsl >> /tmp/out.txt; echo "Done." | lolcat -a -s 100;
